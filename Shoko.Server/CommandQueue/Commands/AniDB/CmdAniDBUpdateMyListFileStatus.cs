                        ...
                        foreach (var xref in xrefs)
                        {
                            ...
                            if (WatchedDateAsSecs > 0)
                            {
                                ...
                                ShokoService.AnidbProcessor.UpdateMyListFileStatus(vid, episode.AnimeID,
                                    episode.EpisodeNumber, (Shoko.Models.Enums.EpisodeType) episode.EpisodeType, Watched, watchedDate);
                            }
                            else
                                ShokoService.AnidbProcessor.UpdateMyListFileStatus(vid, episode.AnimeID,
                                    episode.EpisodeNumber, (Shoko.Models.Enums.EpisodeType) episode.EpisodeType, Watched);
                        }
                    }
